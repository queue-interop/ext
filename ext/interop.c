...
zend_class_entry *interop_queue_exception_invaliddestinationexception_ce;
zend_class_entry *interop_queue_exception_invalidmessageexception_ce;
...
static PHP_MINIT_FUNCTION(interop)
{
	...
	ZEPHIR_INIT(Interop_Queue_Exception_InvalidDestinationException);
	ZEPHIR_INIT(Interop_Queue_Exception_InvalidMessageException);
